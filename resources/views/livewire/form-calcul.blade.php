<div>
    <form action="" class="relative bg-none" x-data="formBM" x-cloak>
        ...
        <div class="w-1/4 sm:w-1/2 mx-auto bg-slate-200 p-4 rounded grid gap-10 capitalize">
            ...
            <div class="result">
                ...
                <div class="bg-slate-100 rounded px-3 my-3 w-1/3 shadow-lg py-4" x-show="$wire.ResultShow"  wire:key='{{ rand()}}'>
